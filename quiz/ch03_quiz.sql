...
-- 정답:
SELECT name, category FROM products WHERE NOT category = '전자기기';

-- 문제 5
-- 재고가 10개 이하인 제품 중 가격을 20% 할인해 제품명과 가격을 조회하세요.

-- 정답:
SELECT name, price*0.8 FROM products WHERE stock <= 10;
...
-- 정답:
select name, stock*price as '총판매액' from products;
