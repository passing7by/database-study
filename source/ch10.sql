-- Active: 1749604230285@@127.0.0.1@3306@data_modeling
/*
10. 데이터 모델링
10.1 데이터 모델링이란
*/
...
-- 컬럼의 조합을 고유키로 지정하는 경우, UNIQUE(컬럼1, 컬럼2)로 작성
...
CREATE TABLE product (
	...
	-- NOT NULL UNIQUE 속성을 가진 컬럼은 언제는 PK가 될 수 있음(후보키, 대체키)
